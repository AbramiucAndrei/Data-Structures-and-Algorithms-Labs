...
void testRevinoKPasi() {
    ...
    AB a1(1), a2(2), a3(3), a4(4);

    AB tree(a1, 1, a2);
    tree.adaugaSubDr(a3);
    tree.drept().adaugaSubSt(a4);
...
//           4
    ...
    //IteratorPreordine* it = dynamic_cast<IteratorPreordine*>(tree.iterator("preordine"));
    IteratorPreordine* it = (IteratorPreordine*)tree.iterator("preordine");
    it->prim();
    it->urmator();
    it->urmator();
    it->revinoKPasi(1);
